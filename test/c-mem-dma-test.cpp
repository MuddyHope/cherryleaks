...
/** MEMORY_DATA_MALLOC */
TEST(cMemDma, test_malloc_struct_internal) {
  C_MEM_START
    c_mem_entity *buffer;
...
/** MEMORY_DATA_REALLOC */
TEST(cMemDma, test_realloc_struct_internal) {
  C_MEM_START
    c_mem_entity *buffer;
...
/** MEMORY_DATA_CALLOC */
TEST(cMemDma, test_calloc_struct_internal) {
  C_MEM_START
    c_mem_entity *buffer;
...
/** MEMORY_DATA_FREE */
TEST(cMemDma, test_free_struct_internal) {
  C_MEM_START
    c_mem_entity *buffer;
